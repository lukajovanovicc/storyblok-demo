    ...
    >
      <div className='container mx-auto px-4 md:px-0'>
        <div className='-mx-4 flex flex-wrap'>
            ...
            <div className='mb-10 w-full'>
              ...
              <p className='flex items-center text-sm font-medium text-white'>
                <span className='mr-3 text-white'>
                  ...
                  >
                    <g clipPath='url(#clip0_941_16258)'>
                      <path
          ...
          {group?.map(({ title, links }, index) => (
            <LinkGroup key={index} header={title}>
              {links?.map(({ link, label }, linkIndex) => (
                <NavLink
                  key={linkIndex}
                  label={label}
            ...
            <div className='mb-10 w-full'>
              ...
              <div className='mb-6 flex items-center'>
                <a
                  ...
                  className='mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke/30 text-white hover:border-white hover:bg-white hover:text-primary sm:mr-4 lg:mr-3 xl:mr-4'
                >
                  <svg
                    width='8'
                    height='16'
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits='userSpaceOnUse'
              >
                <stop stopColor='#FFFFFF37' stopOpacity='0.34' />
