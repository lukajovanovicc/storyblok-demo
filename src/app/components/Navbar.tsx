  ...
  return (
    ...
    >
      <div className='container px-4'>
        <div className='relative py-4 lg:py-0 flex items-center justify-between w-full'>
          ...
          <button
            ...
            className={` ${open && 'navbarTogglerActive'} rounded-lg lg:hidden`}
          >
          ...
          <nav
            style={{ backgroundColor: mainColor }}
            className={`absolute overflow-hidden right-0 duration-300 top-full rounded-b-lg z-50 w-full max-w-full lg:static lg:block lg:py-0 ${
              !open
                ? 'h-0 lg:h-auto lg:translate-y-0 lg:opacity-100'
                : 'h-[30vh]'
            } `}
          >
            <ul className='block lg:flex lg:justify-center p-5 lg:p-0'>
                ...
                return (
                  <li key={index}>
                    <Link
                      ...
                      } flex flex-col py-2 text-base font-medium group lg:ml-12 lg:inline-flex lg:py-6`}
                    >
                      {text}
                      {page === formattedText && (
                      ...
                      {page !== formattedText && (
                        <span className='w-0 h-[2px] duration-300 group-hover:w-full bg-white' />
                      )}
                    </Link>
                  </li>
                );
