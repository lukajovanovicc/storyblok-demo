        ...
        <div className='-mx-4 flex flex-wrap items-center justify-center'>
          <div className='w-full px-4 lg:w-1/2'>
            <div className='mb-12 max-w-[465px] lg:mb-0'>
              <span className='text-blue-500 xs:text-xl mb-[18px] block text-lg font-semibold'>
                {label}
              </span>
              <h2 className='mb-6 text-2xl font-semibold !leading-tight xl:text-[36px]'>
                {title}
              </h2>
              <span className='bg-blue-500 mb-6 block h-[3px] w-[100px]'></span>
              <p className='text-body-color dark:text-dark-6 mb-9 text-base'>
                {description}
              </p>
              <Link
                href='#'
                className='bg-blue-500 inline-flex items-center justify-center rounded-md py-[13px] px-7 text-center text-base font-medium text-white hover:bg-blue-dark'
              >
