...
const Accordion: FC<Props> = ({ header, text, mainColor, darkTheme }) => {
  const [active, setActive] = useState(false);

  return (
    <div
      className={`mb-8 w-full rounded-lg p-4 ${
        darkTheme
          ? 'shadow-[0px_20px_95px_0px_rgba(0,0,0,0.30)] '
          : 'shadow-[0px_20px_95px_0px_rgba(201,203,204,0.30)] '
      } sm:p-8 lg:px-6 xl:px-8`}
    >
      <button
